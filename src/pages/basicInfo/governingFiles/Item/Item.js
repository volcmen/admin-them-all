...
class Item extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`${config.api.apiRest}/requests/getGoverningFile/${id}`, fetchConf)
    ...
    sendSave() {
        ...
        return fetch(`${config.api.apiRest}/requests/updateGoverningFile/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
    ...
    deleteDocument() {
        ...
        return fetch(`${config.api.apiRest}/requests/deleteGoverningFile/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
                    return history.push('/');
            ...
            <div>
                ...
                <Card body outline color="primary" className="mt-2">
                    <Row className={s.ItemElems}>
                        ...
                        <Col md="4">
                            <Link to="/app/basic-information/gov-files">
                                <Button color="secondary" className={s.ContrlButtons}>Close</Button>
                            </Link>
                        </Col>
                        {this.state.document._id !== 'new' &&
                        <Col md="4">
