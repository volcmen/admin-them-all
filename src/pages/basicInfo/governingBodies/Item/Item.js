...
class Item extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`${config.api.apiRest}/requests/getGoverningBodie/${id}`, fetchConf)
    ...
    sendSave() {
        ...
        return fetch(`${config.api.apiRest}/requests/updateGoverningBodie/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
    ...
    deletePerson() {
        ...
        return fetch(`${config.api.apiRest}/requests/deleteGoverningBodie/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
                    return history.push('/');
            ...
            <div>
                ...
                <Card body outline color="primary" className="mt-2">
                    <Row className={s.ItemElems}>
                        ...
                        <Col md="4">
                            <Link to="/app/basic-information/gov-bodies">
                    ...
                    <InputGroup className={s.ItemElems}>
                        ...
                        <Input type="email" name="email" placeholder="me@me.me" value={person.email} onChange={this.inputChange} />
                    </InputGroup>
                    <InputGroup className={s.ItemElems}>
