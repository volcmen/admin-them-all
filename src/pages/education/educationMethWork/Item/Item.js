...
class Item extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`${config.api.apiRest}/requests/getEdMethWork/${id}`, fetchConf)
    ...
    sendSave() {
        ...
        return fetch(`${config.api.apiRest}/requests/updateEdMethWork/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
    ...
    deleteDocument() {
        ...
        return fetch(`${config.api.apiRest}/requests/deleteEdMethWork/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
                    return history.push('/app/education/meth-work');
        ...
        return (
            <div>
                ...
                <Card body outline color="primary" className="mt-2">
                    <ItemStatuses itemId={this.state.document._id} save={this.sendSave} closeLink="education/meth-work" tgModal={this.toggleModal} />
