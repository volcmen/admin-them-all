...
class Document extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`${config.api.apiRest}/requests/getDocument/${id}`, fetchConf)
    ...
    inputChange(e) {
        console.log('input change called', e);
    ...
    sendSave() {
        ...
        return fetch(`${config.api.apiRest}/requests/updateDocument/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
    ...
    deleteDocument() {
        ...
        return fetch(`${config.api.apiRest}/requests/deleteDocument/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
                    return history.push('/app/documents/documents');
        ...
        return (
            <div>
                ...
                <Card body outline color="primary" className="mt-2">
                    <ItemStatuses itemId={this.state.document._id} save={this.sendSave} closeLink="documents/documents" tgModal={this.toggleModal} />
