...
class Item extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`${config.api.apiRest}/requests/getLogistic/${id}`, fetchConf)
    ...
    sendSave() {
        ...
        return fetch(`${config.api.apiRest}/requests/updateLogistic/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
    ...
    deleteDocument() {
        ...
        return fetch(`${config.api.apiRest}/requests/deleteLogistic/${this.props.match.params.id}`, fetchConf)
            .then((response) => {
                if (response.ok)
                    return history.push('/app/logistics/logistics');
        ...
        return (
            <div>
                ...
                <Card body outline color="primary" className="mt-2">
                    <ItemStatuses itemId={this.state.document._id} save={this.sendSave} closeLink="logistics/logistics" tgModal={this.toggleModal} />
                    ...
                    <Row>
                        ...
                        <UncontrolledDropdown className={s.ItemElems}>
                            ...
                            <DropdownMenu>
                                <DropdownItem name="category" value="main" onClick={this.inputChange}>Main</DropdownItem>
                                <DropdownItem name="category" value="med" onClick={this.inputChange}>Medicine</DropdownItem>
                                <DropdownItem name="category" value="catering" onClick={this.inputChange}>Catering</DropdownItem>
                                <DropdownItem name="category" value="library" onClick={this.inputChange}>Library</DropdownItem>
                            </DropdownMenu>
                        </UncontrolledDropdown>
                    </Row>
