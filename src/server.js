...
app.get('*', async (req, res, next) => {
    try {
        ...
        const data = {
            title: 'Admin to RULE THE WORLD',
            description: 'Admin to rule sites',
        };
        data.styles = [
        ...
        const html = ReactDOM.renderToString(<StaticRouter
            location={req.url}
            context={context}
        >
            <Provider store={store}>
                <App store={store} authToken={req.cookies.id_token} />
            </Provider>
                                             </StaticRouter>);
